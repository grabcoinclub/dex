      ...
      <BodyWrapper style={{ padding: 24 }}>
        <AutoColumn gap="16px">
          <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
            ...
            <div>
              <QuestionHelper text={<Trans>Migrate your liquidity tokens from Poolex to Poolex V3.</Trans>} />
            </div>
          </AutoRow>

          <ThemedText.Body style={{ marginBottom: 8, fontWeight: 400 }}>
            <Trans>
              For each pool shown below, click migrate to remove your liquidity from Poolex and deposit it into
              Poolex V3.
            </Trans>
          </ThemedText.Body>
