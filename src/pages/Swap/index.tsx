...
import { CheckCircle, HelpCircle, Info, Repeat } from 'react-feather'
...
import { ButtonConfirmed, ButtonError, ButtonGradient, ButtonPrimary } from '../../components/Button'
          ...
          <AutoColumn gap={'sm'}>
              ...
              <>
                <AutoRow justify="space-between" style={{ padding: '0 1rem' }}>
                  <ArrowWrapper clickable={false}>
                    <Repeat size="16" color={theme.text6} />
                  </ArrowWrapper>
            ...
            <div>
              {swapIsUnsupported ? (
                ...
                <ButtonGradient onClick={toggleWalletModal}>
